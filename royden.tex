...
\begin{enumerate}
	...
	(Cantor's Theorem: for a set $A$, any function $f:A\to \mathcal{P}(A)$ is not surjective.)
	...
	\item Show that a nondegenerate interval of real numbers fails to be finite.
