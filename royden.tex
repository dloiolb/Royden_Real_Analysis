...
\defineauthorcolor{finished}{black}% Author B will be coloured blue
\defineauthorcolor{inprogress}{BlueViolet}% Author B will be coloured blue
\defineauthorcolor{untouched}{ForestGreen}% Author A will be coloured red
...
\author{J.B.}
\date{\small May, June, August 2024
}
