...
\begin{enumerate}
	...
	Suppose $E$ is not measurable. Because every set of infinite outer measure is measurable, $E$ must be of finite outer measure.
	Because $E$ is not measurable, there exists a set $A$ such that 
	\[
		m^*(A)>m^(A\cap E)+m^*(A\cap E^c).
	\]
